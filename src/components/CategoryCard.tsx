...
export function CategoryCard({ type, count, onPress }: CategoryCardProps) {
  ...
  return (
    <TouchableOpacity style={[styles.container, shadows.md]} onPress={onPress} activeOpacity={0.85}>
      <LinearGradient
      ...
      >
        ...
        <View style={styles.iconContainer}>
          <Ionicons name={config.icon as any} size={24} color="rgba(255, 255, 255, 0.9)" />
        </View>
    ...
    >
      ...
      >
        ...
        <View style={styles.largeIconContainer}>
          <Ionicons name={config.icon as any} size={32} color="rgba(255, 255, 255, 0.95)" />
        </View>
...
export function CategoryFilterCard({
  ...
  return (
    <TouchableOpacity
      style={[styles.filterCard, isSelected && shadows.md, !isSelected && { opacity: 0.6 }]}
      onPress={onPress}
      activeOpacity={0.8}
    >
      <LinearGradient
...
export function CategoryChip({ type, label, icon, isSelected, count, onPress }: CategoryChipProps) {
  ...
  return (
    ...
    >
      ...
      <ThemedText
        variant="caption"
        style={[styles.chipLabel, { color: isSelected ? '#FFFFFF' : colors.textSecondary }]}
      >
        {label}
      </ThemedText>
