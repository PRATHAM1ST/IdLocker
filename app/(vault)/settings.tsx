...
} from "../../src/context/AuthLockProvider";
				...
				{ text: "Cancel", style: "cancel" },
				{
					...
					onPress: async () => {
						...
						if (success) {
							Alert.alert(
								"Success",
								"All vault data has been cleared."
							);
						} else {
							Alert.alert(
								"Error",
				...
				>
					...
					>
						...
						<View style={styles.infoItem}>
							...
							>
								All data is encrypted and stored only on this
								device
							</ThemedText>
						</View>
						...
						>
							...
							>
								Your data may be lost if you uninstall the app
								or change device security settings. We recommend
								keeping a separate backup of critical
								information.
							</ThemedText>
						</View>
					</View>
					...
					{renderSection(
						...
						<View style={{ padding: spacing.base }}>
							...
							<ThemedText
								variant="caption"
								color="tertiary"
								style={styles.dangerHint}
							>
								This will permanently delete all your vault
								items
							</ThemedText>
						</View>
					)}
